# ThreatClaw ↔ OpenClaw Feature Parity Matrix

This document tracks feature parity between ThreatClaw (Rust implementation) and OpenClaw (TypeScript reference implementation). Use this to coordinate work across developers.
...
| Feature | OpenClaw | ThreatClaw | Notes |
|---------|----------|----------|-------|
...
| Channel | OpenClaw | ThreatClaw | Priority | Notes |
|---------|----------|----------|----------|-------|
| CLI/TUI | ✅ | ✅ | - | Ratatui-based TUI |
| HTTP webhook | ✅ | ✅ | - | axum with secret validation |
| REPL (simple) | ✅ | ✅ | - | For testing |
| WASM channels | ❌ | ✅ | - | ThreatClaw innovation; host resolves owner scope vs sender identity |
...
| Feature | OpenClaw | ThreatClaw | Notes |
|---------|----------|----------|-------|
| DM pairing codes | ✅ | ✅ | `threatclaw pairing list/approve`, host APIs |
...
| Command | OpenClaw | ThreatClaw | Priority | Notes |
|---------|----------|----------|----------|-------|
...
| Feature | OpenClaw | ThreatClaw | Notes |
|---------|----------|----------|-------|
| Pi agent runtime | ✅ | ➖ | ThreatClaw uses custom runtime |
...
| Provider | OpenClaw | ThreatClaw | Priority | Notes |
|----------|----------|----------|----------|-------|
...
| Tinfoil | ❌ | ✅ | - | Private inference provider (ThreatClaw-only) |
...
| Feature | OpenClaw | ThreatClaw | Priority | Notes |
|---------|----------|----------|----------|-------|
...
| Workspace-relative install | ✅ | ✅ | ~/.threatclaw/tools/ |
...
| Hot-reload | ✅ | ❌ | |
| Legacy migration | ✅ | ➖ | |
| State directory | ✅ `~/.openclaw-state/` | ✅ `~/.threatclaw/` | |
...
| Gemini embeddings | ✅ | ❌ | |
| Local embeddings | ✅ | ❌ | |
| SQLite-vec backend | ✅ | ❌ | ThreatClaw uses PostgreSQL |
...
| DM pairing verification | ✅ | ✅ | threatclaw pairing approve, host APIs |
...
| WASM sandbox | ❌ | ✅ | ThreatClaw innovation |
...
- ✅ DM pairing (threatclaw pairing list/approve, host APIs)
- ✅ WASM tool sandbox
...
ThreatClaw intentionally differs from OpenClaw in these ways:
...
7. **Tinfoil private inference**: ThreatClaw-only provider for private/encrypted inference
