...
export const SECTIONS: Record<SectionKey, Section> = {
  ...
  skills: {
    ...
    items: [
      ...
      {
        href: "/billing",
        labelFr: "Quota assets",
        labelEn: "Asset quota",
        icon: Lock,
        tooltipFr: "Visualisation du quota d'assets et tier actuel. Pas de paiement ici — l'achat se fait sur threatclaw.io/pricing.",
        tooltipEn: "Asset quota and current tier visualisation. No payment here — purchase happens at threatclaw.io/pricing.",
      },
    ],
  },
  scans: {
