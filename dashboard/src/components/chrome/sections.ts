...
export const SECTIONS: Record<SectionKey, Section> = {
  ...
  inventaire: {
    ...
    items: [
      ...
      {
        href: "/threat-map",
        labelFr: "Prédiction d'attaque",
        labelEn: "Attack Prediction",
        icon: Crosshair,
        tooltipFr: "Top chemins d'attaque vers les assets critiques + fixes prioritaires — calcul automatique toutes les 6 h.",
        tooltipEn: "Top attack paths to critical assets + priority fixes — auto-computed every 6h.",
      },
    ],
  },
  investigation: {
  ...
  skills: {
    ...
    items: [
      ...
      },
      {
        ...
        labelEn: "License & instance",
        icon: Key,
        tooltipFr: "Plan, quota d'assets, gestion de la licence et infos de cette installation.",
        tooltipEn: "Plan, asset quota, license management and this install's info.",
      },
    ],
  },
  scans: {
