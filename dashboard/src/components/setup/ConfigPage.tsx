...
const DEFAULT_ANONYMIZER_RULES = [
  ...
  { prefix: "SSHKEY", labelKey: "cfg_ruleSshKeys", pattern: "-----BEGIN * PRIVATE KEY-----", example: "Clé entière → [SSHKEY-001]" },
  ...
  { prefix: "GCPKEY", labelKey: "cfg_ruleGcpKeys", pattern: '"type": "service_account"', example: "JSON SA détecté → [GCPKEY-001]" },
