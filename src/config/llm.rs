    ...
    pub fn for_testing() -> Self {
        Self {
            ...
            session: SessionConfig {
                ...
                session_path: std::env::temp_dir().join("threatclaw-test-session.json"),
            },
            nearai: NearAiConfig {
...
/// Get the default session file path (~/.threatclaw/session.json).
pub fn default_session_path() -> PathBuf {
    threatclaw_base_dir().join("session.json")
}
