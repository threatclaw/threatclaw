// English Language Pack for ThreatClaw

I18n.register('en', {
  // Auth Page
  'auth.title': 'ThreatClaw',
  ...
  // Restart Modal
  'restart.title': 'Restart ThreatClaw Instance',
  'restart.description': 'Are you sure you want to restart ThreatClaw? This will gracefully restart the process.',
  ...
  'restart.progressTitle': 'Restarting ThreatClaw',
  ...
  'config.telegramOwnerHint': 'After saving, ThreatClaw will show a one-time code. Send `/start CODE` to your bot in Telegram and ThreatClaw will finish setup automatically.',
