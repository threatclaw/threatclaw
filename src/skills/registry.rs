...
//! 2. User skills directory (`~/.threatclaw/skills/`) -- Trusted
//!
...
pub struct SkillRegistry {
    ...
    /// User skills directory (~/.threatclaw/skills/). Skills here are Trusted.
    user_dir: PathBuf,
    /// Registry-installed skills directory (~/.threatclaw/installed_skills/). Skills here are Installed.
