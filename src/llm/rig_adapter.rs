//! Generic adapter that bridges rig-core's `CompletionModel` trait to ThreatClaw's `LlmProvider`.
//!
...
/// Convert ThreatClaw messages to rig-core format.
///
...
/// Convert ThreatClaw tool definitions to rig-core format.
///
...
/// Convert ThreatClaw tool_choice string to rig-core ToolChoice.
...
fn extract_response(
    ...
    for content in choice.iter() {
        match content {
            ...
            // Reasoning and Image variants are not mapped to ThreatClaw types
            _ => {}
        }
    }
