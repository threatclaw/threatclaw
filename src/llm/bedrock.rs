...
/// Convert ThreatClaw `ChatMessage` list into Bedrock system blocks + messages.
///
...
/// Build Bedrock `ToolConfiguration` from ThreatClaw tool definitions.
...
/// Map Bedrock `StopReason` to ThreatClaw `FinishReason`.
