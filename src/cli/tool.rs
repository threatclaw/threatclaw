...
pub enum ToolCommand {
    ...
    Install {
        ...
        /// Target directory for installation (default: ~/.threatclaw/tools/)
        #[arg(short, long)]
    ...
    List {
        /// Directory to list tools from (default: ~/.threatclaw/tools/)
        #[arg(short, long)]
        dir: Option<PathBuf>,
    ...
    Remove {
        ...
        /// Directory to remove tool from (default: ~/.threatclaw/tools/)
        #[arg(short, long)]
        dir: Option<PathBuf>,
    },
    ...
    Info {
        ...
        /// Directory to look for tool (default: ~/.threatclaw/tools/)
        #[arg(short, long)]
        dir: Option<PathBuf>,
    },
...
async fn list_tools(dir: Option<PathBuf>, verbose: bool) -> anyhow::Result<()> {
    ...
    if !tools_dir.exists() {
        ...
        println!("Install a tool with: threatclaw tool install <path>");
        return Ok(());
    }
        ...
        .ok_or_else(|| {
            anyhow::anyhow!(
                "OAuth client_id not configured.\n\
                 Set {} env var, or build with THREATCLAW_GOOGLE_CLIENT_ID.",
    ...
    let setup = caps.setup.ok_or_else(|| {
        anyhow::anyhow!(
            "Tool '{}' has no setup configuration.\n\
             ...
             Try 'threatclaw tool auth {}' for OAuth-based authentication.",
            name,
            name
        )
    })?;
...
mod tests {
    ...
    fn test_default_tools_dir() {
        ...
        assert!(dir.to_string_lossy().contains(".threatclaw"));
