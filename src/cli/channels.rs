...
//!
//! `status` (runtime health) requires connecting to a running ThreatClaw instance
...
async fn cmd_list(
    ...
    if !verbose {
        ...
        println!("managed via environment variables. See 'threatclaw onboard --channels-only'.");
    }
