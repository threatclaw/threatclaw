...
//! functions from `threatclaw::bootstrap`, ensuring test coverage of the actual
//! escaping/formatting logic rather than a reimplementation.

use std::collections::HashMap;
use tempfile::tempdir;

use threatclaw::bootstrap::{save_bootstrap_env_to, upsert_bootstrap_var_to};
...
fn bootstrap_env_preserves_existing_values() {
    ...
    let initial_vars: &[(&str, &str)] = &[
        ...
        (
            "DATABASE_URL",
            "postgres://user:pass@localhost:5432/threatclaw",
        ),
        ("LLM_BACKEND", "nearai"),
    ...
    assert_eq!(
        ...
        Some("postgres://user:pass@localhost:5432/threatclaw"),
...
fn bootstrap_env_handles_special_characters() {
    ...
    let test_cases: &[(&str, &str)] = &[
        // Spaces in values
        ("AGENT_NAME", "my threatclaw agent"),
        ...
        ("WIN_PATH", r"C:\Users\threatclaw\data"),
