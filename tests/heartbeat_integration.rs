...
async fn test_heartbeat_end_to_end() {
    ...
    let _ = tracing_subscriber::fmt()
        .with_env_filter("threatclaw=debug")
        .try_init();
    ...
    let hb_config = threatclaw::agent::HeartbeatConfig::default();
    let hygiene_config = threatclaw::workspace::hygiene::HygieneConfig::default();
    ...
    println!("=== Result ===\n");
    match &result {
        threatclaw::agent::HeartbeatResult::Ok => {
        ...
        threatclaw::agent::HeartbeatResult::Skipped => {
        ...
        threatclaw::agent::HeartbeatResult::Failed(err) => {
